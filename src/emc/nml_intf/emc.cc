...
/*
*	NML/CMS Update function for mcodeCtx
*	Automatically generated by NML CodeGen Java Applet.
*	on Sat Oct 11 13:45:17 UTC 2026
*/
void MCodeCtx_update(CMS * cms, EMC_TASK_MCODE_CTX * mcodeCtx)
{
    for (int i = 0; i < EMC_MAX_ACTIVE_MCODE_LIST; i++) 
    {
        cms->update(mcodeCtx->activeMCodeList[i].mNumber);
...
/*
*	NML/CMS Update function for EMC_M_CODE_MEG
*	Manually generated by IkariHJ.
*	on Sun Sep 12 15:15:17 EET 2026
*/
